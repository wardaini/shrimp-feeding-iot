...
<body class="bg-gradient-primary">
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        <div class="container d-flex justify-content-center">
            <a class="navbar-brand text-primary text-center" style="font-weight: 900;" href="<?= base_url('') ?>">
                <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Manajemen Pemberian Pakan Udang Vaname
            </a>
        </div>
    </nav>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <img src="<?= base_url('assets/') ?>img/logo.png" alt="" width="30%"
